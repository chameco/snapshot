...
boolean has_iotm(int y, int m) {
	...
	case 2006:
		switch (m) {
		case  1: return has_item("Tome of Snowcone Summoning");
		...
		case  4: return has_item("McPhee's Grimoire of Hilarious Object Summoning");
	...
	case 2007:
		...
		case  2: return has_item("Libram of Candy Heart Summoning");
	...
	case 2008:
		switch (m) {
		case  1: return has_item("Libram of Divine Favors");
		...
		case  4: return has_item("Sp'n-Zor's Grimoire of &quot;Tasteful&quot; Gifts");
		...
		case 11: return has_item("Scratch 'n' Sniff Sticker Tome");
	...
	case 2009:
		...
		case  2: return has_item("Libram of Love Songs");
		...
		case  9: return has_item("Tome of Sugar Shummoning");
	...
	case 2010:
		...
		case  2: return has_item("Libram of BRICKOS");
		...
		case 12: return has_item("hibernating robot reindeer") || has_familiar("Robot Reinderr");
		default: return false;
		}
	case 2011:
		switch (m) {
		...
		case  3: return has_item("Sorcerers of the Shore Grimoire");
		case  4: return has_item("Clan VIP Lounge invitation") || has_item("Clan VIP Lounge key");
		case  5: return has_item("My Own Pen Pal kit");
		...
		case  9: return has_item("Tome of Clip Art");
	...
	case 2012:
		switch (m) {
		case  1: return has_item("Libram of Resolutions");
		...
		case 12: return has_item("Thinknerd's Grimoire of Geeky Gifts");
		default: return false;
		}
	case 2013:
		switch (m) {
		case  1: return has_item("Snow Suit");
		case  2: return has_item("GameInformPowerDailyPro subscription card");
		case  3: return has_item("Jarlsberg's pan") || has_item("Jarlsberg's pan (Cosmic portal mode)");
		case  4: return has_item("Libram of Pulled Taffy");
		case  5: return has_item("Order of the Green Thumb Order Form");
		...
		case 12: return has_item("The Smith's Tome");
		default: return false;
		}
	case 2014:
		switch (m) {
		...
		case  5: return has_item("airplane charter: Spring Break Beach");
		...
		case 10: return has_item("airplane charter: Conspiracy Island");
	...
	case 2015:
		switch (m) {
		case  1: return has_item("Chateau Mantegna room key");
		case  2: return has_item("bottle of lovebug pheromones");
		case  3: return has_item("Ed the Undying exhibit crate") || has_item("The Crown of Ed the Undying");
		case  4: return has_item("airplane charter: Dinseylandfill");
		...
		case  8: return has_item("airplane charter: That 70s Volcano");
		case  9: return has_item("shrine to the Barrel god");
		case 10: return has_item("Haunted Doghouse");
		case 11: return has_item("airplane charter: The Glaciest");
		case 12: return has_item("machine elf capsule") || has_familiar("Machine Elf");
		default: return false;
		}
	case 2016:
		switch (m) {
		case  1: return has_item("X-32-F snowman crate");
		case  2: return has_item("LT&T telegraph office deed");
		...
		case  7: return has_item("detective school application");
		...
		case 11: return has_item("Granny Tood's Thanksgarden Catalog") || has_item("packet of thanksgarden seeds");
		case 12: return has_item("Build-a-City Gingerbread kit");
		default: return false;
		}
	case 2017:
		switch (m) {
		case  1: return has_item("space planula") || has_familiar("Space Jellyfish");
		case  2: return has_item("heart-shaped crate");
		case  3: return has_item("unpowered Robortender") || has_familiar("Robortender");
		case  4: return has_item("Spacegate access badge");
		case  5: return has_item("New-You Club Membership Form");
